 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://service.compair.adeng.com/", wsdlLocation = "http://localhost:8989/WS_Server/WebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://service.compair.adeng.com/", "WebServiceImplService");
    ...
    public WebService getWebServiceImplPort() {
        return super.getPort(new QName("http://service.compair.adeng.com/", "WebServiceImplPort"), WebService.class);
    }
    ...
    public WebService getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.compair.adeng.com/", "WebServiceImplPort"), WebService.class, features);
    }
